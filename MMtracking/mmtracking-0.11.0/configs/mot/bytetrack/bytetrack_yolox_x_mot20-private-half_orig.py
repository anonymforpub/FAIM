_base_ = ['./bytetrack_yolox_x_crowdhuman_mot17-private-half_orig.py']
...
data = dict(
    ...
    val=dict(
        ...
        img_prefix='data/MOT20/train_old',
...
work_dir = './work_dirs/bytetrack_yolox_x_mot20-private-half_orig_allinterval_eval'
