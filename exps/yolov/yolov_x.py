...
class Exp(MyExp):
    def __init__(self):
        ...
        self.num_classes = 30
        self.data_dir = "../../dataset_annotations/imagenetVID_2015" #path to your dataset
    ...
    def get_data_loader(
        ...
        dataset = vid.VIDDataset(file_path='../../dataset_annotations/imagenetVID_2015/YOLOV_annotations/train_seq.npy',
